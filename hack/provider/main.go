...
var checksumMap = map[string]string{
	"./release/devpod-provider-flow-linux-amd64":       "##CHECKSUM_LINUX_AMD64##",
	"./release/devpod-provider-flow-linux-arm64":       "##CHECKSUM_LINUX_ARM64##",
	"./release/devpod-provider-flow-darwin-amd64":      "##CHECKSUM_DARWIN_AMD64##",
	"./release/devpod-provider-flow-darwin-arm64":      "##CHECKSUM_DARWIN_ARM64##",
	"./release/devpod-provider-flow-windows-amd64.exe": "##CHECKSUM_WINDOWS_AMD64##",
}
